...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-vs-mda-remote/node_modules/vs-mda-remote/lib/BuildLogger.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-vs-mda-remote/node_modules/vs-mda-remote/lib/BuildLogger.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-vs-mda-remote/node_modules/vs-mda-remote/lib/</a> &#187; BuildLogger.js</div>
</div>
<div class="body">
...
var fs = require('fs'),
    path = require('path');
&nbsp;
var BuildLogger = exports = module.exports = <span class="fstat-no" title="function not covered" >function BuildLogger() {</span>
<span class="cstat-no" title="statement not covered" >    this.stream = null;</span>
};
&nbsp;
BuildLogger.prototype = {
    begin: <span class="fstat-no" title="function not covered" >function(buildDir, logFileName, buildProcess) {</span>
<span class="cstat-no" title="statement not covered" >        var pathToBuildLog = path.join(buildDir, logFileName);</span>
<span class="cstat-no" title="statement not covered" >        this.stream = fs.createWriteStream(pathToBuildLog);</span>
<span class="cstat-no" title="statement not covered" >        console.info('Opened build log file %s', pathToBuildLog);</span>
...
<span class="cstat-no" title="statement not covered" >            console.error('Error from writing to stream at %s: %s', pathToBuildLog, err);</span>
        });
<span class="cstat-no" title="statement not covered" >        var me = this;</span>
<span class="cstat-no" title="statement not covered" >        buildProcess.stdout.on('data', <span class="fstat-no" title="function not covered" >function(data) {</span></span>
<span class="cstat-no" title="statement not covered" >            me.log(data);</span>
        });
<span class="cstat-no" title="statement not covered" >        buildProcess.stderr.on('data', <span class="fstat-no" title="function not covered" >function(data) {</span></span>
<span class="cstat-no" title="statement not covered" >            me.log(data);</span>
        });
    },
&nbsp;
