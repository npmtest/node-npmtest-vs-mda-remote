...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-vs-mda-remote/node_modules/vs-mda-remote/lib/buildRetention.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-vs-mda-remote/node_modules/vs-mda-remote/lib/buildRetention.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-vs-mda-remote/node_modules/vs-mda-remote/lib/</a> &#187; buildRetention.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="cstat-no" title="statement not covered" >var br = exports = module.exports = {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >var baseBuildDir;</span>
<span class="cstat-no" title="statement not covered" >var maxBuildsToKeep;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >br.init = <span class="fstat-no" title="function not covered" >function(baseBuildDir, conf) {</span></span>
<span class="cstat-no" title="statement not covered" >    maxBuildsToKeep = conf.get('maxBuildsToKeep');</span>
<span class="cstat-no" title="statement not covered" >    console.info('Build Retention initialized with baseBuildDir %s, maxBuildsToKeep %d', baseBuildDir, maxBuildsToKeep);</span>
};
&nbsp;
<span class="cstat-no" title="statement not covered" >br.purge = <span class="fstat-no" title="function not covered" >function(builds) {</span></span>
<span class="cstat-no" title="statement not covered" >    var buildNumbers = Object.keys(builds);</span>
<span class="cstat-no" title="statement not covered" >    var nBuildsToDelete = buildNumbers.length - maxBuildsToKeep;</span>
<span class="cstat-no" title="statement not covered" >    if (nBuildsToDelete &lt;= 0) {</span>
<span class="cstat-no" title="statement not covered" >        return;</span>
    }
&nbsp;
    // eligible builds do not include those queued up or currently building.
<span class="cstat-no" title="statement not covered" >    var eligibleBuilds = [];</span>
<span class="cstat-no" title="statement not covered" >    for (var i = 0; i &lt; buildNumbers.length; i++) {</span>
<span class="cstat-no" title="statement not covered" >        var buildInfo = builds[buildNumbers[i]];</span>
<span class="cstat-no" title="statement not covered" >        if (buildInfo.status === bi.COMPLETE || buildInfo.status === bi.DOWNLOADED ||</span>
            buildInfo.status === bi.DELETED || buildInfo.status === bi.ERROR ||
            buildInfo.status === bi.EMULATED || buildInfo.status === bi.INVALID) {
<span class="cstat-no" title="statement not covered" >            eligibleBuilds.push(buildInfo);</span>
        }
    };
    // sort eligible builds by oldest first, then delete required number
<span class="cstat-no" title="statement not covered" >    eligibleBuilds.sort(<span class="fstat-no" title="function not covered" >function(b1, b2) {</span></span>
<span class="cstat-no" title="statement not covered" >        var diff = b1.submissionTime - b2.submissionTime;</span>
<span class="cstat-no" title="statement not covered" >        return (diff === 0) ? 0 : (diff &gt; 0 ? +1 : -1);</span>
    });
<span class="cstat-no" title="statement not covered" >    if (nBuildsToDelete &gt; eligibleBuilds.length) {</span>
<span class="cstat-no" title="statement not covered" >        nBuildsToDelete = eligibleBuilds.length;</span>
    }
<span class="cstat-no" title="statement not covered" >    console.info('Deleting eligible builds. Will delete %d builds.', nBuildsToDelete);</span>
<span class="cstat-no" title="statement not covered" >    for (var i = 0; i &lt; nBuildsToDelete; i++) {</span>
<span class="cstat-no" title="statement not covered" >        var buildInfo = eligibleBuilds[i];</span>
<span class="cstat-no" title="statement not covered" >        console.info('Deleting build %d from %s', buildInfo.buildNumber, buildInfo.buildDir);</span>
<span class="cstat-no" title="statement not covered" >        br.deleteBuildDirectory(buildInfo.buildDir);</span>
<span class="cstat-no" title="statement not covered" >        delete builds[eligibleBuilds[i].buildNumber];</span>
    }
};
&nbsp;
<span class="cstat-no" title="statement not covered" >br.deleteAllSync = <span class="fstat-no" title="function not covered" >function(builds) {</span></span>
<span class="cstat-no" title="statement not covered" >    var buildNumbers = Object.keys(builds);</span>
<span class="cstat-no" title="statement not covered" >    for (var i = 0; i &lt; buildNumbers.length; i++) {</span>
<span class="cstat-no" title="statement not covered" >        var buildInfo = builds[buildNumbers[i]];</span>
<span class="cstat-no" title="statement not covered" >        console.info('Deleting build %d from %s', buildInfo.buildNumber, buildInfo.buildDir);</span>
<span class="cstat-no" title="statement not covered" >        rimraf.sync(buildInfo.buildDir);</span>
<span class="cstat-no" title="statement not covered" >        delete builds[buildNumbers[i]];</span>
    }
};
&nbsp;
<span class="cstat-no" title="statement not covered" >br.deleteBuildDirectory = <span class="fstat-no" title="function not covered" >function(buildDir, callback) {</span></span>
<span class="cstat-no" title="statement not covered" >    rimraf(buildDir, <span class="fstat-no" title="function not covered" >function(err) {</span></span>
