...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-vs-mda-remote/node_modules/vs-mda-remote/lib/appInstaller.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-vs-mda-remote/node_modules/vs-mda-remote/lib/appInstaller.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-vs-mda-remote/node_modules/vs-mda-remote/lib/</a> &#187; appInstaller.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="cstat-no" title="statement not covered" >var installer = exports = module.exports = {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >installer.install = <span class="fstat-no" title="function not covered" >function (ipaPath) {</span></span>
<span class="cstat-no" title="statement not covered" >    var quoteSafeIpaPath = util.quotesAroundIfNecessary(ipaPath);</span>
<span class="cstat-no" title="statement not covered" >    var deferred = Q.defer();</span>
<span class="cstat-no" title="statement not covered" >    exec('ideviceinstaller -i ' + quoteSafeIpaPath, <span class="fstat-no" title="function not covered" >function (err, stdout, stderr) {</span></span>
<span class="cstat-no" title="statement not covered" >		if (stdout.indexOf("ApplicationVerificationFailed") &gt; -1) {</span>
<span class="cstat-no" title="statement not covered" >			deferred.reject({ reason: 'ProvisioningFailed' });</span>
		} else <span class="cstat-no" title="statement not covered" >if (err) {</span>
<span class="cstat-no" title="statement not covered" >			if (err.message.indexOf("No iOS device found, is it plugged in?") &gt; -1) {</span>
<span class="cstat-no" title="statement not covered" >				deferred.reject({ reason: 'InstallFailNoDevice' });</span>
			} else {
<span class="cstat-no" title="statement not covered" >				deferred.reject(err);</span>
			}
        } else <span class="cstat-no" title="statement not covered" >if (stderr.toLowerCase().indexOf("error") &gt; -1) {</span>
<span class="cstat-no" title="statement not covered" >            deferred.reject(stderr);</span>
        } else {
<span class="cstat-no" title="statement not covered" >            deferred.resolve(stdout);</span>
        }
    });
