...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-vs-mda-remote/node_modules/vs-mda-remote/lib/emulate.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-vs-mda-remote/node_modules/vs-mda-remote/lib/emulate.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-vs-mda-remote/node_modules/vs-mda-remote/lib/</a> &#187; emulate.js</div>
</div>
<div class="body">
...
var path = require('path'),
    ...
    util = require('./util');
&nbsp;
<span class="cstat-no" title="statement not covered" >var e = exports = module.exports = {};</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >process.on('message', <span class="fstat-no" title="function not covered" >function (emulateRequest) {</span></span>
<span class="cstat-no" title="statement not covered" >    e.emulate(emulateRequest, <span class="fstat-no" title="function not covered" >function (result) {</span></span>
<span class="cstat-no" title="statement not covered" >        process.send(result);</span>
    });
});
&nbsp;
<span class="cstat-no" title="statement not covered" >e.emulate = <span class="fstat-no" title="function not covered" >function(emulateRequest, callback) {</span></span>
<span class="cstat-no" title="statement not covered" >    console.info('Emulating app at ' + emulateRequest.appDir + ' for target ' + emulateRequest.target);</span>
<span class="cstat-no" title="statement not covered" >    var error = null;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    try {</span>
<span class="cstat-no" title="statement not covered" >        Q(cdToAppDir(emulateRequest)).</span>
        then(cordovaEmulate).
...
<span class="cstat-no" title="statement not covered" >                callback({status: 'error', messageId: 'EmulateFailedWithError', messageArgs: error.message});</span>
            } else {
<span class="cstat-no" title="statement not covered" >                callback({status: 'emulated', messageId: 'EmulateSuccess'});</span>
            }
        });
    } catch (e) {
<span class="cstat-no" title="statement not covered" >        callback({status: 'error', messageId: 'EmulateFailedWithError', messageArgs: e.message});</span>
    }
};
&nbsp;
<span class="cstat-no" title="statement not covered" >e.init = <span class="fstat-no" title="function not covered" >function() {</span></span>
<span class="cstat-no" title="statement not covered" >    process.env['PATH'] = path.resolve(__dirname, path.join('..','node_modules','ios-sim','build','release')) + ':' + process.env['PATH'];</span>
<span class="cstat-no" title="statement not covered" >    require('child_process').exec('which ios-sim', <span class="fstat-no" title="function not covered" >function(err, stdout, stderr) {</span></span>
<span class="cstat-no" title="statement not covered" >        if (err !== null) {</span>
<span class="cstat-no" title="statement not covered" >            console.error('****** ios-sim is not installed on path. `sudo npm install -g ios-sim` if you want this server to support emulator.');</span>
        } else {
<span class="cstat-no" title="statement not covered" >            console.info('ios-sim is installed on path at: %s', stdout);</span>
        }
    });
};
&nbsp;
<span class="fstat-no" title="function not covered" >function cdToAppDir(emulateRequest) {</span>
<span class="cstat-no" title="statement not covered" >    process.chdir(emulateRequest.appDir);</span>
<span class="cstat-no" title="statement not covered" >    return emulateRequest;</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function cordovaEmulate(emulateRequest) {</span>
<span class="cstat-no" title="statement not covered" >    var deferred = Q.defer();</span>
<span class="cstat-no" title="statement not covered" >    var emulatorAppPath = util.quotesAroundIfNecessary(path.join(emulateRequest.appDir, 'platforms', 'ios', 'build', 'emulator', emulateRequest.appName + '.app'));</span>
<span class="cstat-no" title="statement not covered" >    exec('killall \'iPhone Simulator\'', <span class="fstat-no" title="function not covered" >function (error, stdout, stderr) {</span></span>
<span class="cstat-no" title="statement not covered" >        exec('ios-sim launch ' + emulatorAppPath + ' ' + iosSimTarget(emulateRequest.target) + ' --exit', <span class="fstat-no" title="function not covered" >function (error, stdout, stderr) {</span></span>
<span class="cstat-no" title="statement not covered" >            if (error !== null) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >var iosSimTargets = {</span>
    'iphone 4s': '--retina',
...
&nbsp;
<span class="fstat-no" title="function not covered" >function iosSimTarget(emulateRequestTarget) {</span>
<span class="cstat-no" title="statement not covered" >    emulateRequestTarget = emulateRequestTarget.toLowerCase();</span>
<span class="cstat-no" title="statement not covered" >    var iosSimTarget = iosSimTargets[emulateRequestTarget] || '--family iphone --retina';</span>
<span class="cstat-no" title="statement not covered" >    return iosSimTarget;</span>
}
