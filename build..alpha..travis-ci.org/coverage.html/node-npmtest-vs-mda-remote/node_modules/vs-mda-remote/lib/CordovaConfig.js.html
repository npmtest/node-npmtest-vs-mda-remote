...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-vs-mda-remote/node_modules/vs-mda-remote/lib/CordovaConfig.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-vs-mda-remote/node_modules/vs-mda-remote/lib/CordovaConfig.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-vs-mda-remote/node_modules/vs-mda-remote/lib/</a> &#187; CordovaConfig.js</div>
</div>
<div class="body">
...
var et = require('elementtree'),
	...
	unorm = require('unorm');
&nbsp;
<span class="fstat-no" title="function not covered" >function CordovaConfig(configXmlPath) {</span>
<span class="cstat-no" title="statement not covered" >    var contents = util.readFileContentsSync(configXmlPath, 'utf-8');</span>
<span class="cstat-no" title="statement not covered" >    this.doc = new et.ElementTree(et.XML(contents));</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function getNodeTextSafe(doc, nodeName) {</span>
<span class="cstat-no" title="statement not covered" >    var el = doc.find(nodeName);</span>
<span class="cstat-no" title="statement not covered" >    return el &amp;&amp; el.text &amp;&amp; el.text.trim().normalize();</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function getRootAttributeValueSafe(doc, attribName) {</span>
<span class="cstat-no" title="statement not covered" >    var el = doc.getroot();</span>
<span class="cstat-no" title="statement not covered" >    return el &amp;&amp; el.attrib &amp;&amp; el.attrib[attribName];</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function getPreferences(doc) {</span>
<span class="cstat-no" title="statement not covered" >    var data = {};</span>
    
<span class="cstat-no" title="statement not covered" >    var preferences = doc.findall('preference');</span>
<span class="cstat-no" title="statement not covered" >    preferences.forEach(<span class="fstat-no" title="function not covered" >function (preference) {</span></span>
<span class="cstat-no" title="statement not covered" >        data[preference.attrib['name']] = preference.attrib['value'];</span>
    });
    
<span class="cstat-no" title="statement not covered" >    return data;</span>
}
&nbsp;
<span class="cstat-no" title="statement not covered" >CordovaConfig.prototype = {</span>
    id: <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >        return this.doc.getroot().attrib.id;</span>
    },
    name: <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >        return getNodeTextSafe(this.doc, 'name');</span>
    },
    version: <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >        return getRootAttributeValueSafe(this.doc, 'version');</span>
    },
    preferences: <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >	    return getPreferences(this.doc);</span>
    },
};
&nbsp;
<span class="cstat-no" title="statement not covered" >module.exports = CordovaConfig;</span>
&nbsp;
