...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-vs-mda-remote/node_modules/vs-mda-remote/lib/plist.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-vs-mda-remote/node_modules/vs-mda-remote/lib/plist.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-vs-mda-remote/node_modules/vs-mda-remote/lib/</a> &#187; plist.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="cstat-no" title="statement not covered" >var plist = exports = module.exports = {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >var templateContents = null;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >plist.createEnterprisePlist = <span class="fstat-no" title="function not covered" >function(cordovaConfigOrPathToConfigXml, outFilePath) {</span></span>
<span class="cstat-no" title="statement not covered" >    var cfg = cordovaConfigOrPathToConfigXml;</span>
<span class="cstat-no" title="statement not covered" >    if (typeof cordovaConfigOrPathToConfigXml === 'string') {</span>
<span class="cstat-no" title="statement not covered" >        cfg = new CordovaConfig(cordovaConfigOrPathToConfigXml);</span>
    }
<span class="cstat-no" title="statement not covered" >    var id = cfg.id();</span>
<span class="cstat-no" title="statement not covered" >    var version = cfg.version();</span>
<span class="cstat-no" title="statement not covered" >    var name = cfg.name();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var plistContents = getTemplateContents();</span>
<span class="cstat-no" title="statement not covered" >    plistContents = plistContents.replace('${BUNDLE_IDENTIFIER}', id);</span>
<span class="cstat-no" title="statement not covered" >    plistContents = plistContents.replace('${APPLICATION_VERSION}', version);</span>
<span class="cstat-no" title="statement not covered" >    plistContents = plistContents.replace('${DISPLAY_NAME}', name);</span>
<span class="cstat-no" title="statement not covered" >    util.writeFileContentsSync(outFilePath, plistContents);</span>
<span class="cstat-no" title="statement not covered" >    console.info('Created plist file %s from template with [%s, %s, %s]', outFilePath, id, version, name);</span>
};
&nbsp;
<span class="cstat-no" title="statement not covered" >plist.updateAppBundleVersion = <span class="fstat-no" title="function not covered" >function(pathToAppPlist, buildNumber) {</span></span>
<span class="cstat-no" title="statement not covered" >    var plistInfo = pl.parseFileSync(pathToAppPlist);</span>
<span class="cstat-no" title="statement not covered" >    var version = plistInfo['CFBundleVersion'];</span>
<span class="cstat-no" title="statement not covered" >    version = version ? version + '.' + buildNumber : ''+buildNumber;</span>
<span class="cstat-no" title="statement not covered" >    plistInfo['CFBundleVersion'] = version;</span>
<span class="cstat-no" title="statement not covered" >    var updatedPlistContents = pl.build(plistInfo);</span>
<span class="cstat-no" title="statement not covered" >    updatedPlistContents = updatedPlistContents.replace(/&lt;string&gt;[\s\r\n]*&lt;\/string&gt;/g,'&lt;string&gt;&lt;/string&gt;');</span>
<span class="cstat-no" title="statement not covered" >    fs.writeFileSync(pathToAppPlist, updatedPlistContents, 'utf-8');</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function getTemplateContents() {</span>
<span class="cstat-no" title="statement not covered" >    if (templateContents === null) {</span>
<span class="cstat-no" title="statement not covered" >        var templatePath = path.join(__dirname, '..', 'templates', 'EnterpriseApp.plist');</span>
<span class="cstat-no" title="statement not covered" >        templateContents = util.readFileContentsSync(templatePath, 'utf-8');</span>
    }
<span class="cstat-no" title="statement not covered" >    return templateContents;</span>
}
&nbsp;
