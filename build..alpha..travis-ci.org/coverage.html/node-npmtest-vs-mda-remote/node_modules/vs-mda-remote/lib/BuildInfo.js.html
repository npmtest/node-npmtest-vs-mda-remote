...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-vs-mda-remote/node_modules/vs-mda-remote/lib/BuildInfo.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-vs-mda-remote/node_modules/vs-mda-remote/lib/BuildInfo.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-vs-mda-remote/node_modules/vs-mda-remote/lib/</a> &#187; BuildInfo.js</div>
</div>
<div class="body">
...
var resources = require('./resources'),
    util = require('./util');
&nbsp;
<span class="fstat-no" title="function not covered" >function BuildInfo(buildNumber, status, cordovaVersion, buildCommand, configuration, options, buildDir, serverDir) {</span>
<span class="cstat-no" title="statement not covered" >    this.buildNumber = buildNumber;</span>
<span class="cstat-no" title="statement not covered" >    this.status = status;</span>
<span class="cstat-no" title="statement not covered" >    this.cordovaVersion = cordovaVersion;</span>
<span class="cstat-no" title="statement not covered" >    this.buildCommand = buildCommand;</span>
...
<span class="cstat-no" title="statement not covered" >    this.buildDir = buildDir;</span>
<span class="cstat-no" title="statement not covered" >    this.serverDir = serverDir,</span>
    this.submissionTime = new Date();
<span class="cstat-no" title="statement not covered" >    this.changeList = null;</span>
};
&nbsp;
<span class="cstat-no" title="statement not covered" >BuildInfo.prototype.updateStatus = <span class="fstat-no" title="function not covered" >function(status, messageId, messageArgs) {</span></span>
<span class="cstat-no" title="statement not covered" >    this.status = status;</span>
...
<span class="cstat-no" title="statement not covered" >        this.messageArgs = util.getOptionalArgsArrayFromFunctionCall(arguments, 2);</span>
    } 
<span class="cstat-no" title="statement not covered" >    this.statusTime = new Date();</span>
};
&nbsp;
<span class="cstat-no" title="statement not covered" >BuildInfo.prototype.localize = <span class="fstat-no" title="function not covered" >function(req) {</span></span>
<span class="cstat-no" title="statement not covered" >    if (this.messageId) {</span>
<span class="cstat-no" title="statement not covered" >        this.message = resources.getString(req, this.messageId, this.messageArgs);</span>
    } else {
<span class="cstat-no" title="statement not covered" >        this.message = resources.getString(req, 'Build-'+this.status);</span>
    }
<span class="cstat-no" title="statement not covered" >    return this;</span>
};
&nbsp;
<span class="cstat-no" title="statement not covered" >module.exports.BuildInfo = BuildInfo;</span>
<span class="cstat-no" title="statement not covered" >module.exports.createNewBuildInfoFromDataObject = <span class="fstat-no" title="function not covered" >function(buildInfoData) {</span></span>
<span class="cstat-no" title="statement not covered" >    var bi = new BuildInfo();</span>
<span class="cstat-no" title="statement not covered" >    Object.keys(buildInfoData).forEach(<span class="fstat-no" title="function not covered" >function(k) {</span> <span class="cstat-no" title="statement not covered" >bi[k] = buildInfoData[k]; </span>});</span>
<span class="cstat-no" title="statement not covered" >    return bi;</span>
};
&nbsp;
<span class="cstat-no" title="statement not covered" >module.exports.UPLOADING = 'uploading';</span>
<span class="cstat-no" title="statement not covered" >module.exports.UPLOADED = 'uploaded';</span>
<span class="cstat-no" title="statement not covered" >module.exports.EXTRACTED = 'extracted';</span>
<span class="cstat-no" title="statement not covered" >module.exports.INVALID = 'invalid';</span>
<span class="cstat-no" title="statement not covered" >module.exports.BUILDING = 'building';</span>
<span class="cstat-no" title="statement not covered" >module.exports.COMPLETE = 'complete';</span>
<span class="cstat-no" title="statement not covered" >module.exports.EMULATED = 'emulated';</span>
<span class="cstat-no" title="statement not covered" >module.exports.RUNNING = 'running';</span>
<span class="cstat-no" title="statement not covered" >module.exports.INSTALLED = 'installed';</span>
<span class="cstat-no" title="statement not covered" >module.exports.DOWNLOADED = 'downloaded';</span>
<span class="cstat-no" title="statement not covered" >module.exports.DELETED = 'deleted';</span>
<span class="cstat-no" title="statement not covered" >module.exports.ERROR = 'error';</span>
&nbsp;
